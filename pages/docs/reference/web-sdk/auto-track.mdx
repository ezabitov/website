...
export const meta = {
  title: 'Автоматическое отслеживание в WebSDK',
}
...
Содержит данные производительности сети и браузера, которые находятся в `perf` [общей структуры данных](https://rock.st/docs/reference/web-sdk/event-struct/)
...
Сами данные скрола находятся в `scroll` [общей структуры данных](https://rock.st/docs/reference/web-sdk/event-struct/)
