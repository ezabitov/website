...
Обращение к сервису платформы. Можно уведомить, например, сервис персонализированного поп-апа о совершении события.
Сервис должен быть объявлен как (`handler`)[https://rock.st/docs/reference/band-framework/python-api/].
...
Открытие чата с поддержкой в случае некорректного заполнения формы:
